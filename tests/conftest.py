...
from tests.core.conftest import (
    ...
    DEFAULT_E2E_STORIES_FILE, DEFAULT_STACK_CONFIG,
    DEFAULT_STORIES_FILE,
    END_TO_END_STORY_FILE,
    INCORRECT_NLU_DATA, SIMPLE_STORIES_FILE,
)
...
@pytest.fixture(scope="session")
async def trained_simple_rasa_model(  # TODO: can we combine?
    trained_async: Callable,
    default_domain_path: Text,
    default_nlu_data: Text,
...
@pytest.fixture(scope="function")  # TODO: make work with session
